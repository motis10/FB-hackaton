...
function generateTransaction(people, currencies) {
    var currency = randomInt(0, currencies.length);
    var otherCurrencies = currencies.filter(function (value, index) { return index != currency; });
    var amount = randomInt(0, 40);
    var result = {
...
for (var _i = 0, _a = generateTransactions(); _i < _a.length; _i++) {
    var value = _a[_i];
